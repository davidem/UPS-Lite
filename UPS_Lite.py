...
class UPS():
        ...
        def read_status(self,capacity,voltage,prev_capacity,prev_voltage,prev_status):
...
def main():
        ...
        status = ups_lite.read_status(capacity,voltage,prev_capacity,prev_voltage,prev_status)
